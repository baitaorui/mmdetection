...
class RepYOLOXHead(BaseDenseHead, BBoxTestMixin):
    ...
    def init_weights(self):
        super(RepYOLOXHead, self).init_weights()
    ...
    def loss(self,
        ...
        (pos_masks, cls_targets, obj_targets, bbox_targets, l1_targets,
         num_fg_imgs, pos_assigned_gt_inds) = multi_apply(
        ...
        # print(pos_masks)
        # print("cccc")
        # # print(flatten_bboxes)
        # print(gt_bboxes)
        bb = [flatten_bboxes[i][pos_masks[i]] for i in range(0, num_imgs)]
        # print(bb)
        ...
        # print(flatten_bboxes.view(-1, 4)[pos_masks].shape[0])
        # print(bbox_targets.shape[0])
        # if(flatten_bboxes.view(-1, 4)[pos_masks].shape[0] != bbox_targets.shape[0]):
        #     print("!!!!!!!!!!!!!")
        # print("bbbbbbbbbb")
        # print(flatten_bboxes.view(-1, 4)[pos_masks].shape)
        # print(bbox_targets.shape)
        
        loss_bbox = self.loss_bbox(
            bb, pos_assigned_gt_inds, gt_bboxes, flatten_bboxes.view(-1, 4)[pos_masks], bbox_targets) / num_total_samples
    ...
    @force_fp32(apply_to=('cls_preds', 'objectness', 'decoded_bboxes'))
    @torch.no_grad()
    def _get_target_single(self, cls_preds, objectness, priors, decoded_bboxes,
        ...
        # print("aaaaaaaaaaa")
        # print([i for i  in assign_result.gt_inds != False])
        ...
        return (foreground_mask, cls_target, obj_target, bbox_target,
                l1_target, num_pos_per_img, pos_assigned_gt_inds)
